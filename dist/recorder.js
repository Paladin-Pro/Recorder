...
},{"./recorder":2,"./worker":3}],2:[function(require,module,exports){
'use strict';
...
exports.default = getRecorderWorker;
...
var self = {};
function getRecorderWorker() {
    return new _inlineWorker2.default(function () {
        var recLength = 0,
            recBuffers = [],
            sampleRate = void 0,
            numChannels = void 0;
